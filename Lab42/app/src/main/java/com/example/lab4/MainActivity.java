...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text_usuario= findViewById(R.id.textEmail);
        Button boton_login=findViewById(R.id.butLogin);
        Button boton_logout=findViewById(R.id.butLogout);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_nuevo_formulario) {
